              ...
              tabsetPanel(id='instruction',
                          tabPanel(title = "Introduction",
                                   ...
                                   HTML("<p>ATAC-DEA website:
                                        ...
                                        <p>Programming language: R(>=4.0)<p>"),
                                   HTML("<p><b><font size='3'>For For technique help, please contact Sufang Wang, sufangwang@nwpu.edu.cn.</font></b></p>"),
                                   ...
                                   hr(),
                                   HTML('<a href="https://beian.miit.gov.cn/#/Integrated/index">   豫ICP备2022001350号</a>')
                          ...
                          tabPanel(title="Data Upload",
                                   fluidRow(
                                     ...
                                     box(
                                       ...
                                       collapsible = TRUE, width=12,
                                       tableOutput("sampleSheet")%>% withSpinner(color="#3c8cbc"),
                                     )
                                   ))
